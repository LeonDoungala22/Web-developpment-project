...
import in.co.student.enrollment.sys.ctl.BaseCtl;
import in.co.student.enrollment.sys.ctl.SESView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(SESView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
